...
@ObjectType()
export class MedicalSpecialtiesFilter implements IEntityFilter<MedicalSpecialtiesEntity>{
...
export const MedicalSpecialtiesFilterInput = FilterType(MedicalSpecialtiesFilter);